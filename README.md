...
4. Oeffne `config.js`.
5. Trage dort deine Werte aus **Project URL** und **anon public key** ein.
...
Danach speichert FriendTiers die Liste in Supabase und laedt sie in jedem Browser wieder.
